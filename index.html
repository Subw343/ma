      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 header__content">
            <h1 class="title">Rapid-Sec            <span class="title-style"></span></h1>
            <p>My Journey to Bug Bounty</p>
      ...
      <div class="container">
        <div class="page-section">
          <div class="text-center">
            <h2 class="page-section__title">People You should follow</h2>
              ...
              <div class="thumbnail team__single">
                ...
                <div class="caption">
                  ...
                  <div class="social-icons">
                    ...
                    <li><a href="https://twitter.com/hak5"><i class="flaticon-twitter-logo-silhouette"></i></a></li>
